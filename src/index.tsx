...
export function viewportCoordsToSceneCoords(
  ...
  const y = clientY - CANVAS_WINDOW_OFFSET_TOP - scrollY - 84;
  return { x, y };
}
...
export class BinderEditor extends React.Component<BinderEditorProps, AppState> {
  canvas: HTMLCanvasElement | null = null;
  rc: RoughCanvas | null = null;

  actionManager: ActionManager = new ActionManager();
  canvasOnlyActions: Array<Action>;
  constructor(props: BinderEditorProps) {
    super(props);
      ...
      <>
        <div className="header">
          <div className="content">
            <div className="row">
              {this.props.actions && this.props.actions.backButton && (
                <Button
                  label={this.props.actions.backButton.label}
                  buttonSize={ButtonSize.small}
                  buttonType={ButtonType.secondary}
                  icon={<BackArrowIcon />}
                  {...this.props.actions.backButton.buttonProps}
                />
              )}
          ...
          <main>
            <canvas
              ...
              onMouseDown={e => {
                ...
                const onMouseMove = (e: MouseEvent) => {
                  ...
                  if (!isLinear) {
                    ...
                    draggingElement.y =
                      y < originY ? originY - height : originY;
                  }
              ...
              onMouseMove={e => {
                ...
                document.documentElement.style.cursor = hitElement
                  ? "move"
                  : "";
              }}
            >
...
export class TopErrorBoundary extends React.Component {
  ...
  private async createGithubIssue() {
    ...
    window.open(
      `https://github.com/marcelovicentegc/binder-editor/issues/new?body=${body}`,
    );
  }
